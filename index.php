...
<head>
  <meta charset="UTF-8">
  <title>Alexandra Birthday Gift</title>
...
<div id="merrywrap" class="merrywrap">
  <div class="giftbox">
    ...
    <div class="box"></div>
        ...
        <span class="space"/><span class="comments">* Сегодня, 6-е декабря, твой день рождения.</span><br />
        <span class="space"/><span class="comments">* И я решил создать страничку чтобы отпраздновать этот день.</span><br />
        <span class="space"/><span class="comments">*/</span><br />
        Girl u = <span class="keyword">new</span> Girl(<span class="string">"Alexandra Loboda"</span>);<br />
        ...
        if( dateString.equals(<span class="string">"2025-12-06 00:00:00"</span>) ){</br>
          u.age ++;</br>
        }</br>
