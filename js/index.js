...
window.requestAnimFrame = function () {
 ...
 window.addEventListener('load', function() {
     // Your JavaScript code to execute after the full page load goes here
     ...
     if (myElement) {
         myElement.textContent = 'Content updated after full page load!';
     }
...
// main demo loop
     ...
     together.setFullYear(2002,12, 6);
     together.setHours(8);
